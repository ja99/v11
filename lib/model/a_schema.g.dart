...
part of 'a_schema.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<ASchema> _$aSchemaSerializer = new _$ASchemaSerializer();

class _$ASchemaSerializer implements StructuredSerializer<ASchema> {
  @override
  final Iterable<Type> types = const [ASchema, _$ASchema];
  @override
  final String wireName = 'ASchema';

  @override
  Iterable<Object> serialize(Serializers serializers, ASchema object,
  ...
  @override
  ASchema deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ASchemaBuilder();
...
class _$ASchema extends ASchema {
  @override
  ...
  factory _$ASchema([void Function(ASchemaBuilder) updates]) =>
      (new ASchemaBuilder()..update(updates)).build();
  ...
  @override
  ASchema rebuild(void Function(ASchemaBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ASchemaBuilder toBuilder() => new ASchemaBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ASchema &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('ASchema')
...
class ASchemaBuilder implements Builder<ASchema, ASchemaBuilder> {
  _$ASchema _$v;
  ...
  @override
  void replace(ASchema other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$ASchema;
  }

  @override
  void update(void Function(ASchemaBuilder) updates) {
